...
const postModelLayouts = async (modelType, modelId, layoutJson: Layout[], layoutId = '') => {
    if (layoutId) {
...
export const ExperienceEditor = () => {
    ...
    const { data, layout, setLayout, existingLayoutId } = useContentData(contentType, itemId);
